...
export class MarginUniApi {
    ...
    public async getUniCurrencyPair(currencyPair: string) : Promise<{ response: AxiosResponse; body: UniCurrencyPair; }> {
        const localVarPath = this.client.basePath + '/margin/uni/currency_pairs/{currency_pair}'
     ...
     */
    public async getMarginUniEstimateRate(currencies: Array<string>) : Promise<{ response: AxiosResponse; body: { [key: string]: string; }; }> {
     ...
     */
    public async listUniLoans(opts: { currencyPair?: string, currency?: string, page?: number, limit?: number,  } ) : Promise<{ response: AxiosResponse; body: Array<UniLoan>; }> {
     ...
     * @param opts.limit Maximum response items.  Default: 100, minimum: 1, Maximum: 100
     */
    public async listUniLoanRecords(opts: { type?: 'borrow' | 'repay', currency?: string, currencyPair?: string, page?: number, limit?: number,  } ) : Promise<{ response: AxiosResponse; body: Array<UniLoanRecord>; }> {
     ...
     */
    public async listUniLoanInterestRecords(opts: { currencyPair?: string, currency?: string, page?: number, limit?: number, from?: number, to?: number,  } ) : Promise<{ response: AxiosResponse; body: Array<UniLoanInterestRecord>; }> {
     ...
     * @param currencyPair Currency pair
     */
    public async getUniBorrowable(currency: string, currencyPair: string) : Promise<{ response: AxiosResponse; body: MaxUniBorrowable; }> {
