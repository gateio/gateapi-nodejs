...
------------ | ------------- | ------------- | -------------
**succeeded** | **boolean** | Request execution result | [optional] [default to undefined]
...
**size** | **number** | Required. Trading quantity. Positive for buy, negative for sell. Set to 0 for close position orders. | [optional] [default to undefined]
